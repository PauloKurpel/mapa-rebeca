...
@Component({
  selector: 'app-mapa-sc',
  templateUrl: './mapa-sc.component.html',
  styleUrls: ['./mapa-sc.component.css']
})
export class MapaScComponent {
  ...
  ngOnInit() {
    ...
    this.zoom = 15;
    this.latitude = -22.908333;
    this.longitude = -43.196388;
